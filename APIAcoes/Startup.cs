            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1",
                    new OpenApiInfo
                    {
                        ...
                        Version = "v1",
                        Description = $"Instância: {Environment.MachineName} | Exemplo de API REST criada com o ASP.NET Core 3.1 para o envio de dados de ações a um Tópico do Apache Kafka",
